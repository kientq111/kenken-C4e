...
let txtContent = document.getElementById("content");
let txtAuthor = document.getElementById("author");

btnReload.addEventListener("click", function (e) {
    let rand = Math.floor(Math.random() * 30);
    console.log(rand);
    txtContent.innerHTML = Quotes[rand].quoteText;
    txtAuthor.innerHTML = Quotes[rand].quoteAuthor;
});
